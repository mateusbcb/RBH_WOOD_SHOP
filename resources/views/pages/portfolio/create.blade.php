        ...
        <div class="container">
            <div class="row content-wrapper justify-content-center">
                <div class="col-lg-5 offset-lg-1 bg-white mb-4 mbr-form" data-form-type="formoid">
                    <form action="{{ route('portfolio.store') }}" method="POST" enctype="multipart/form-data" class="mbr-form form-with-styler" data-form-title="Form Name">
                        <div class="dragArea row">
                            ...
                            <div class="col-md col-sm-12 form-group mb-3 shadow-lg py-2" data-for="title">
                                ...
                                <input type="text" name="title" placeholder="Title" data-form-field="title" class="form-control" value="" id="title">
                            </div>
                            ...
                            <div class="col-md col-sm-12 form-group mb-3 shadow-lg py-2" data-for="client">
                                ...
                                <input type="text" name="client" placeholder="Client" data-form-field="client" class="form-control" value="" id="client">
                            </div>
                            ...
                            <div class="col-12 form-group mb-3 shadow-lg py-2" data-for="url">
                                ...
                                <select name="tags[]" name="tags" data-form-field="tags" class="form-control" value="" multiple="multiple" id="tags">
                                    @if(isset($tags))
                                        @foreach ($tags as $tag)
                            ...
                            <div class="col-12 form-group mb-3 shadow-lg py-2" data-for="descrition">
                                ...
                                <textarea name="descrition" placeholder="Descrition" data-form-field="descrition" class="form-control" id="descrition"></textarea>
                            </div>
                ...
                <div class="col-lg-5 offset-lg-1 border border-1 col-12">
                    <div class=" border border-1 mt-4">
                        ...
                        <hr>
                        <div id="preview_cover" class="img_prev d-flex justify-content-center"></div>
                    </div>
                    ...
                    <div class=" border border-1 mt-4 d-flex justify-content-center flex-column">
                        ...
                        <hr>
                        <div id="preview" class="img_prev"></div>
                    </div>
                </div>
            </div>
        </div>
